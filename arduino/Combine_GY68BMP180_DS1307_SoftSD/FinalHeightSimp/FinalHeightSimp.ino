...
#define dataHi PORTD |= _BV(4)
#define dataLo PORTD &= ~_BV(4)

#define shiftClock PORTD |= _BV(3);PORTD &= ~_BV(3);
#define storeClock PORTD |= _BV(5);PORTD &= ~_BV(5);
...
void loop()
{
  ...
  
  {
    ...
    else
    {
      ...
      line[3] = (temp%10);    temp=temp/10;
      line[2] = (temp%10);    temp=temp/10;
      line[1] = (temp%10);    temp=temp/10;
      line[0] = (temp%10);    temp=temp/10;
    //
...
uint8_t wordbyte[] = {~64,~32,~16,~128};

uint8_t linebyte[] = {
/*0*/~(_BV(4)|_BV(5)|_BV(6)|_BV(3)|_BV(0)|_BV(2)),
/*1*/~(_BV(6)|_BV(0)),
/*2*/~(_BV(4)|_BV(6)|_BV(7)|_BV(3)|_BV(2)),
/*3*/~(_BV(4)|_BV(6)|_BV(7)|_BV(0)|_BV(2)),
/*4*/~(_BV(5)|_BV(6)|_BV(0)|_BV(7)),
/*5*/~(_BV(4)|_BV(5)|_BV(0)|_BV(2)|_BV(7)),
/*6*/~(_BV(4)|_BV(5)|_BV(3)|_BV(0)|_BV(2)|_BV(7)),
/*7*/~(_BV(4)|_BV(6)|_BV(0)),
/*8*/~(_BV(4)|_BV(5)|_BV(6)|_BV(3)|_BV(0)|_BV(2)|_BV(7)),
/*9*/~(_BV(4)|_BV(5)|_BV(6)|_BV(0)|_BV(2)|_BV(7)),
};
/*
7658
 4
