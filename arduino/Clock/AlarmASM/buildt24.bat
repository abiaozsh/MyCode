...
del %filename%.s
del a.out
"%arduinopath%\hardware\tools\avr\bin\avr-gcc" -Os -fno-inline -mmcu=attiny24 -save-temps -fverbose-asm -I"%arduinopath%\hardware\arduino\cores\arduino" %filename%.c
"%arduinopath%\hardware\tools\avr\bin\avr-gcc" -Os -fno-inline -mmcu=attiny24                           -I"%arduinopath%\hardware\arduino\cores\arduino" %filename%.c -o %filename%.o
