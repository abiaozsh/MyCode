...
del %filename%.s
del a.out
"%arduinopath%\hardware\tools\avr\bin\avr-gcc" -Os -mmcu=attiny24 -fno-inline -save-temps -fverbose-asm -I"%arduinopath%\hardware\arduino\cores\arduino" %filename%
"%arduinopath%\hardware\tools\avr\bin\avr-gcc" -Os -mmcu=attiny24 -fno-inline                           -I"%arduinopath%\hardware\arduino\cores\arduino" %filename% -o %filename%.o
