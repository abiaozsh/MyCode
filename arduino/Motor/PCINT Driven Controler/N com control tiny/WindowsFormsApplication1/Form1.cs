...
namespace WindowsFormsApplication1
{
	...
	public partial class Form1 : Form
	{
		...
		private void Send(byte dataA1, byte dataA2, byte dataB1, byte dataB2, byte dataC1, byte dataC2, byte dataD1, byte dataD2)
		{
			...
			d[1] = (byte)((((dataD1 & 0x01) >> 0) << 4) | (((dataC1 & 0x01) >> 0) << 3) | (((dataB1 & 0x01) >> 0) << 2) | (((dataA1 & 0x01) >> 0) << 1) | 0x00);
			d[2] = (byte)((((dataD1 & 0x02) >> 1) << 4) | (((dataC1 & 0x02) >> 1) << 3) | (((dataB1 & 0x02) >> 1) << 2) | (((dataA1 & 0x02) >> 1) << 1) | 0x01);
			d[3] = (byte)((((dataD1 & 0x04) >> 2) << 4) | (((dataC1 & 0x04) >> 2) << 3) | (((dataB1 & 0x04) >> 2) << 2) | (((dataA1 & 0x04) >> 2) << 1) | 0x00);
			d[4] = (byte)((((dataD1 & 0x08) >> 3) << 4) | (((dataC1 & 0x08) >> 3) << 3) | (((dataB1 & 0x08) >> 3) << 2) | (((dataA1 & 0x08) >> 3) << 1) | 0x01);
			d[5] = (byte)((((dataD1 & 0x10) >> 4) << 4) | (((dataC1 & 0x10) >> 4) << 3) | (((dataB1 & 0x10) >> 4) << 2) | (((dataA1 & 0x10) >> 4) << 1) | 0x00);
			d[6] = (byte)((((dataD1 & 0x20) >> 5) << 4) | (((dataC1 & 0x20) >> 5) << 3) | (((dataB1 & 0x20) >> 5) << 2) | (((dataA1 & 0x20) >> 5) << 1) | 0x01);
			d[7] = (byte)((((dataD1 & 0x40) >> 6) << 4) | (((dataC1 & 0x40) >> 6) << 3) | (((dataB1 & 0x40) >> 6) << 2) | (((dataA1 & 0x40) >> 6) << 1) | 0x00);
			d[8] = (byte)((((dataD1 & 0x80) >> 7) << 4) | (((dataC1 & 0x80) >> 7) << 3) | (((dataB1 & 0x80) >> 7) << 2) | (((dataA1 & 0x80) >> 7) << 1) | 0x01);
			...
			d[11] = (byte)((((dataD2 & 0x01) >> 0) << 4) | (((dataC2 & 0x01) >> 0) << 3) | (((dataB2 & 0x01) >> 0) << 2) | (((dataA2 & 0x01) >> 0) << 1) | 0x00);
			d[12] = (byte)((((dataD2 & 0x02) >> 1) << 4) | (((dataC2 & 0x02) >> 1) << 3) | (((dataB2 & 0x02) >> 1) << 2) | (((dataA2 & 0x02) >> 1) << 1) | 0x01);
			d[13] = (byte)((((dataD2 & 0x04) >> 2) << 4) | (((dataC2 & 0x04) >> 2) << 3) | (((dataB2 & 0x04) >> 2) << 2) | (((dataA2 & 0x04) >> 2) << 1) | 0x00);
			d[14] = (byte)((((dataD2 & 0x08) >> 3) << 4) | (((dataC2 & 0x08) >> 3) << 3) | (((dataB2 & 0x08) >> 3) << 2) | (((dataA2 & 0x08) >> 3) << 1) | 0x01);
			d[15] = (byte)((((dataD2 & 0x10) >> 4) << 4) | (((dataC2 & 0x10) >> 4) << 3) | (((dataB2 & 0x10) >> 4) << 2) | (((dataA2 & 0x10) >> 4) << 1) | 0x00);
			d[16] = (byte)((((dataD2 & 0x20) >> 5) << 4) | (((dataC2 & 0x20) >> 5) << 3) | (((dataB2 & 0x20) >> 5) << 2) | (((dataA2 & 0x20) >> 5) << 1) | 0x01);
			d[17] = (byte)((((dataD2 & 0x40) >> 6) << 4) | (((dataC2 & 0x40) >> 6) << 3) | (((dataB2 & 0x40) >> 6) << 2) | (((dataA2 & 0x40) >> 6) << 1) | 0x00);
			d[18] = (byte)((((dataD2 & 0x80) >> 7) << 4) | (((dataC2 & 0x80) >> 7) << 3) | (((dataB2 & 0x80) >> 7) << 2) | (((dataA2 & 0x80) >> 7) << 1) | 0x01);
