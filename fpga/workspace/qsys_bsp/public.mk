...
SOPCINFO_FILE := E:/MyCode.github/fpga/qsys/sys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2003040
SOPC_SYSID_FLAG += --sidp=0x2003040
ELF_PATCH_FLAG  += --sidp 0x2003040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1582724956
SOPC_SYSID_FLAG += --timestamp=1582724956
ELF_PATCH_FLAG  += --timestamp 1582724956
