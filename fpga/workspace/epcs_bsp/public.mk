...
SOPCINFO_FILE := E:/MyCode.github/fpga/qsys_sdram/sys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4002060
SOPC_SYSID_FLAG += --sidp=0x4002060
ELF_PATCH_FLAG  += --sidp 0x4002060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1581843026
SOPC_SYSID_FLAG += --timestamp=1581843026
ELF_PATCH_FLAG  += --timestamp 1581843026
