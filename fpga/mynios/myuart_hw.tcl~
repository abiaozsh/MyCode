...
set_module_property NAME myuart
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME myuart
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL myuart
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file myuart.v VERILOG PATH myuart.v TOP_LEVEL_FILE
...
add_interface_port conduit_end debug8 export Output 8
add_interface_port conduit_end debug32 export Output 32
