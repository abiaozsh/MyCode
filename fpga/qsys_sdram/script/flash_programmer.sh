...
#
nios2-flash-programmer "../flash/aaa_epcs.flash" --base=0x4001000 --epcs --sidp=0x4002060 --id=0x0 --timestamp=1581843026 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program --verbose 
...
#
nios2-flash-programmer "../flash/epcs_epcs.flash" --base=0x4001000 --epcs --sidp=0x4002060 --id=0x0 --timestamp=1581843026 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program --verbose 
