...
namespace ConsoleApplication1
{
	class Program
	{
		...
		static string root = @"D:\MTSAT\";
		static string outdir = @"D:\MTSAT\";
		...
		static void Main(string[] args)
		{
			try
			{
				...
				for (DateTime d = DateTime.Parse("2018/01/01 09:00:00"); d < DateTime.Parse("2018/01/01 12:00:00"); d = d.AddMinutes(10))
				{
					list.Add(d);
				}
				...
				Parallel.ForEach(list, d =>
				{
					...
					proc(d, 1000, 1000, 10000, 10000, 0.1);
				});
			}
			catch (Exception ex)
			{
