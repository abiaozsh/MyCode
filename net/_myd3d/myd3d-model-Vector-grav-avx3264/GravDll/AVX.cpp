...
__inline double LengthA(__m256d vec)
{
	__m256d result = _mm256_mul_pd(vec, vec);
	//return _mm256_sqrt_pd(_mm256_set1_pd(result.m256d_f64[0] + result.m256d_f64[1] + result.m256d_f64[2])).m256d_f64[0];
...
void CalcGravityA(int sp, PSpotA* allSpot, int* length)
{
	...
	for(int i = 0;i < sp;i++)
	{
		...
		if (r * 10 < (allSpot[sp].qmass + allSpot[i].qmass))
		{
		...
		//r1.m256d_f64[1] = G;
		//__m256d r2 = r;
		//r2.m256d_f64[1] = spotSp->mass;
		//__m256d r3 = r;
		//r3.m256d_f64[1] = allSpot[i].mass;
		//__m256d r4 = _mm256_mul_pd(_mm256_mul_pd(r1, r2), r3);
		//__m256d r5 = _mm256_permute_pd(r4, 5);
		//__m256d r6 = _mm256_div_pd(r5, r4);
		//r6 = _mm256_permute_pd(_mm256_permute2f128_pd(r6, r6, 0), 0);
		//force = _mm256_add_pd(force,_mm256_mul_pd(diff, r6));
	}
	...
	)
{
	...
	PSpotA* spotList = (PSpotA*)_aligned_malloc(sizeof(PSpotA)*length,16);
