...
namespace myd3d
{
	...
	class D3DDevice
	{
		...
		public D3DCamera camCenter;
		public Device device = null;
		private ArrayList objs = new ArrayList();
		public D3DDevice(PictureBox render1, PictureBox render2)
		{
		...
		public void Render()
		{
			float size = 1f;
			{
				D3DCamera cam = camCenter.Clone();
				cam.x = (float)(cam.x + size * Math.Sin(cam.direction - Math.PI * 0.5) * 0.5);
				cam.z = (float)(cam.z + size * Math.Cos(cam.direction - Math.PI * 0.5) * 0.5);
				cam.direction += 0.05f;
				Render(cam, render1);
			}
		...
		private void Render(D3DCamera cam, PictureBox render)
		{
