		...
		{
			{
				...
				{
					Model m = new Model(device, "moon.x");
				...
				//{
				//    Model m = new Model(device, "Dolphin1.x");
				//    m.zoom(0.001f, 0.001f, 0.001f);
				//    m.move(0, -1, 0);
				//    device.addObject(m);
				//}

				//{
				//    Model m = new Model(device, "Dolphin2.x");
				//    m.zoom(0.001f, 0.001f, 0.001f);
				//    m.move(0, -2, 0);
				//    device.addObject(m);
				//}
				...
				//{
				//    Model m = new Model(device, "Dolphin3.x");
				//    m.zoom(0.001f, 0.001f, 0.001f);
				//    m.move(0, -3, 0);
				//    device.addObject(m);
				//}
