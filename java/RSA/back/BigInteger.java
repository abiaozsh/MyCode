...
class BigInteger extends Number implements Comparable
{
	 ...
	 * representaion of i.
	 */
	protected final static byte trailingZeroTable[] = { -25, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 5, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 6, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 5, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 7, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 5, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 6, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 5, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0, 4, 0, 1, 0, 2, 0, 1, 0, 3, 0, 1, 0, 2, 0, 1, 0 };
	...
	{
		mag = new int[b2.length/4];
		for(int i=0;i<b2.length/4;i++)
		{
			mag[i]=0;
			if(i*4+0<b2.length)
				mag[i] += (int)((b2[i*4+0] & 0xFFl));
			if(i*4+1<b2.length)
				mag[i] += (int)((b2[i*4+1] & 0xFFl)<<8);
			if(i*4+2<b2.length)
				mag[i] += (int)((b2[i*4+2] & 0xFFl)<<16);
			if(i*4+3<b2.length)
				mag[i] += (int)((b2[i*4+3] & 0xFFl)<<24);
		}
		this.signum = 1;
	}
	...
	/**
	 * This private constructor differs from its private cousin with the
	 ...
	 */
	private int compareTo(BigInteger val)
	{
	 ...
	 * @return a negative number, zero, or a positive number as this BigInteger
	 *         is numerically less than, equal to, or greater than <tt>o</tt>,
	 *         which must be a BigInteger.
	 * @throws ClassCastException
	 *             <tt>o</tt> is not a BigInteger.
	...
	/**
	 * Converts this BigInteger to a <code>double</code>. This conversion is
	 * similar to the <a
	...
	/**
	 * Converts this BigInteger to a <code>float</code>. This conversion is
	 * similar to the <a
	 * href="http://java.sun.com/docs/books/jls/second_edition/html/conversions.doc.html#25363"><i>narrowing
	 * primitive conversion</i></a> from <code>double</code> to
	 * <code>float</code> defined in the <a
	 * href="http://java.sun.com/docs/books/jls/html/">Java Language
	 * Specification</a>: if this BigInteger has too great a magnitude to
	 * represent as a <code>float</code>, it will be converted to
	...
	/**
	 * Converts this BigInteger to a <code>long</code>. This conversion is
	 * analogous to a <a
	 * href="http://java.sun.com/docs/books/jls/second_edition/html/conversions.doc.html#25363"><i>narrowing
	 * primitive conversion</i></a> from <code>long</code> to
	 * <code>int</code> as defined in the <a
	...
	private BigInteger oddModPow(BigInteger y, BigInteger z)
	{
		...
		MutableBigInteger q = new MutableBigInteger(), r = new MutableBigInteger(), a2 = new MutableBigInteger(a), b2 = new MutableBigInteger(mod);
...
class BitSieve
{
	 ...
	 * even.
	 */
	protected BitSieve(BigInteger base, int searchLen)
	{
		/*
	 ...
	 */
	protected BigInteger retrieve(BigInteger initValue, int certainty)
	{
...
class SignedMutableBigInteger extends MutableBigInteger
{
	 ...
	 * word capacity.
	 */
	protected SignedMutableBigInteger()
	{
		super();
	}
	 ...
	 * val.
	 */
	protected SignedMutableBigInteger(int val)
	{
		super(val);
	}
	 ...
	 */
	protected void signedAdd(MutableBigInteger addend)
	{
		if (sign == 1)
			add(addend);
		else
	 ...
	 */
	protected void signedSubtract(SignedMutableBigInteger addend)
	{
		if (sign == addend.sign)
			sign = sign * subtract(addend);
		else
