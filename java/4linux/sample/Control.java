...
public class Control extends Servlet {
	...
	public void doReq(Request req, Response res, Server server) throws Exception {
		...
		out.println("}");
		out.println("function copykey()");
		out.println("{");
		out.println("	formKey.key1.value=\"VK_CONTROL\";");
		out.println("	formKey.key2.value=\"VK_C\";");
		out.println("	formKey.submit();");
		out.println("}");
		out.println("function cutkey()");
		out.println("{");
		out.println("	formKey.key1.value=\"VK_CONTROL\";");
		out.println("	formKey.key2.value=\"VK_X\";");
		out.println("	formKey.submit();");
		out.println("}");
		out.println("function pastkey()");
		out.println("{");
		out.println("	formKey.key1.value=\"VK_CONTROL\";");
		...
		out.println("}");
		out.println("</script>");
		out.println("<img src='/Screen.jpg' onclick = 'mouseDown()'>");
		...
		out.println("<input type = button onclick='copykey()' value='control+C'>");
		out.println("<input type = button onclick='cutkey()' value='control+X'>");
		out.println("<input type = button onclick='pastkey()' value='control+V'>");
		out.println("</form>");
