...
def main():
    ...
    #测试  conv1_1 conv1_2 层级 的style  
    

    sess.run([net['input'].assign(style_img)])
    
    cost_style = ( 1.0*build_style_loss(sess.run(net['conv1_1']) ,  net['conv1_1']) +
                   1.1*build_style_loss(sess.run(net['conv1_2']) ,  net['conv1_2']) +
                   1.2*build_style_loss(sess.run(net['conv2_1']) ,  net['conv2_1']) +
                   1.3*build_style_loss(sess.run(net['conv2_2']) ,  net['conv2_2']) +
                   1.3*build_style_loss(sess.run(net['conv3_1']) ,  net['conv3_1']) +
                   1.3*build_style_loss(sess.run(net['conv3_2']) ,  net['conv3_2']) +
                   1.3*build_style_loss(sess.run(net['conv3_3']) ,  net['conv3_3']) +
                   1.3*build_style_loss(sess.run(net['conv3_4']) ,  net['conv3_4'])
                )
    
    cost_total = cost_style#cost_content + STYLE_STRENGTH * 
