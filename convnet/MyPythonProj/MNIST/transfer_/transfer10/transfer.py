...
def build_style_loss(a, x):#a是值，x是tensor
...
def main():
    ...
    cost_total = (
                   1.1*build_style_loss(sess.run(net['conv1_2']) ,  net['conv1_2']) + #测量每个loss的值
                   1.2*build_style_loss(sess.run(net['conv2_2']) ,  net['conv2_2']) +
                   1.3*build_style_loss(sess.run(net['conv3_4']) ,  net['conv3_4']) +
                   1.4*build_style_loss(sess.run(net['conv4_4']) ,  net['conv4_4']) +
                   1.5*build_style_loss(sess.run(net['conv5_4']) ,  net['conv5_4'])
                 )
