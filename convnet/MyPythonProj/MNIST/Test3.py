...
fc2,fc2save = ConvNet.FCLayer(fc1, 3*3*4, loadFromFile=testfile)
deshape = ConvNet.FC2Conv_Reshape(fc2,3,3,4)
uconv1,uconv1save = ConvNet.DeConvLayer(deshape,filterSize=3,output_shape=[1,6,6,2],convStride = 2,loadFromFile = testfile)
