...
def inputs(data_dir, batch_size, name = 'input'):
    ...
    with tf.name_scope(name):
        filenames = [#[os.path.join(data_dir,'train%d.tfrecords' % ii) for ii in range(12)]
            'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train0.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train1.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train2.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train3.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train4.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train5.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train6.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train7.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train8.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train9.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train10.tfrecords', 
             'D:\\work\\MyCode\\convnet\\MyPythonProj\\MNIST\\wgan6/data/img_align_celeba_tfrecords/train11.tfrecords']
    ...
    for epoch in range(EPOCH):
        ...
        for idx in range(start, batch_idxs):
            ...
            if idx % 20 == 0:
                ...
                errD_real = sess.run(d_loss_real,feed_dict={images:loadedimage})
