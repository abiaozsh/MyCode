...
def DeConvLayer(inputT,filterSize,output_shape,convStride,poolSize, loadFromFile = None, noChange=False, isRelu = True,padding = True):
    ...
    #tf.nn.conv2d_transpose(inputT,weights,output_shape=[1,5,5,3],strides=[1,2,2,1],padding="SAME")
