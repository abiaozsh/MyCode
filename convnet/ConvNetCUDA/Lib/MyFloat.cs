...
namespace ConvNet
{
    ...
    public class MultiFloat : MyFloat
    {
        int Count;
        public MultiFloat(int Count, int size)
            : base(Count * size)
        {
            this.Count = Count;
        ...
        public float this[int MyFloatIndex, int idx]
        {
            get
            {
                return base[idx * Count + MyFloatIndex];
            }
            set
            {
                base[idx * Count + MyFloatIndex] = value;
            }
        }
    }
}
