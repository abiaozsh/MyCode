...
//";
			...
			layer_defs.Add(new Def { type = "conv", sx = 5, filters = 8, stride = 1, pad = 2 });// relus like a bit of positive bias to get gradients early
			...
			layer_defs.Add(new Def { type = "conv", sx = 5, filters = 16, stride = 1, pad = 2 });// relus like a bit of positive bias to get gradients early
			layer_defs.Add(new Def { type = "relu" });
