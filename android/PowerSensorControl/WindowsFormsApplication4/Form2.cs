...
namespace WindowsFormsApplication4
{
	public partial class Form2 : Form
	{
		...
		private void button3_Click(object sender, EventArgs e)
		{
			...
			SaveData(@"f:\data\out\201604.txt");
		}
		...
		private void button6_Click(object sender, EventArgs e)
		{
			...
			LoadData(@"f:\data\201605.txt");

			DateTime startdate = DateTime.Parse("2016-05-01");
			DateTime enddate = DateTime.Parse("2016-06-01");
			double price = 0;
			StringBuilder sb = new StringBuilder();
			...
			for (DateTime d = startdate; d < enddate; d = d.AddDays(1))
			{
				...
				}
				{
					...
					double power = calcPower(oldms, currentms);
					double kwh = power * (currentms - oldms) / 3600000000;
					sb.AppendLine(d.ToString("MM-dd") + "\t" + power.ToString("0.00") + "\t" + kwh.ToString("0.00") + "\t" + pricel + "\t" + priceh);
				}
				price += priceh + pricel;
			}
